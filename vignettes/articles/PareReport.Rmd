...
output:
  html_document:
    ...
    theme: cosmo
vignette: >
  %\VignetteIndexEntry{PaRe [0.1.12]}
...
DT::datatable(PaRe::checkDependencies(repo = repo, nThreads = 10))
```
...
graphData <- PaRe::getGraphData(repo = repo, nThreads = 10)
